...
while True:
    ...
    if startGame:
        ...
        if stateResult is False:
            ...
            cv2.putText(img,str(int(timer)),(605,435),cv2.FONT_HERSHEY_PLAIN, 6, (255,255,255), 4)
    ...
    cv2.putText(img, str(scores[0]), (410, 215), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 6)
    cv2.putText(img, str(scores[1]), (1112, 215), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 6)
